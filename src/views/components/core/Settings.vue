...
<script>
  ...
  import sidebar2 from '@/assets/img/layout/sidebar-2.jpg'
  import sidebar3 from '@/assets/img/layout/sidebar-3.jpg'
  import sidebar4 from '@/assets/img/layout/sidebar-4.jpg'
