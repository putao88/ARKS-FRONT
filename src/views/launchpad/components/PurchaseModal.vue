        ...
        <v-card-text>
                ...
                >
                  <div class="d-flex justify-space-between">
                    <span class="d-flex align-center">
                      ...
                      <tooltips
                        tip-text="The Original Purchase Price refers to the initial price of the NFT without the use of any financial instruments."
                      />
                    </span>
                  ...
                  <div class="d-flex justify-space-between">
                    <span class="d-flex align-center">
                      ...
                      <tooltips
                        tip-text="Interest Fee is the amount of interest generated by using leverage and other financial instruments, which depends on the Original Purchase Price, the chosen leverage ratio and duration."
                      />
                    </span>
                    <span>
                      {{ interestFee }}USDT
                  ...
                  <div class="d-flex justify-space-between">
                    <span class="d-flex align-center">
                      ...
                      <tooltips
                        tip-text="The Down Payment Amount is the initial price that needs to be paid, which is equal to the Original Purchase Price when no financial instruments are used."
                      />
                    </span>
                    <span>
                  ...
                  <div class="d-flex justify-space-between">
                    <span class="d-flex align-center">
                      ...
                      <tooltips
                        tip-text="Monthly Payments are the fees that need to be paid on a monthly basis when using financial instruments, which can be paid partially or entirely using the revenue generated by the NFT."
                      />
                    </span>
                    <span>
                      {{ monthlyPayment }}USDT
                  ...
                  <div class="d-flex justify-space-between">
                    <span class="d-flex align-center">
                      ...
                      <tooltips
                        tip-text="Length of Plan refers to the duration of the plan that can be selected when using financial instruments, during which the buyer can enjoy the right to revenue generated by the NFT."
                      />
                    </span>
                  ...
                  <div class="d-flex justify-space-between">
                    <span class="d-flex align-center">
                      ...
                      <tooltips
                        tip-text="Total Purchase Amount is the total cost required to purchase the NFT, which includes the Down Payment Amount and Interest Fee."
                      />
                    </span>
          ...
          <v-card class="pa-4 my-4">
            <div class="d-flex justify-space-between align-center mb-2">
              ...
              <v-icon @click="showExplain = !showExplain">
            ...
            <v-expand-transition>
              <div v-show="showExplain">
                ...
                >
                  ...
                  financial freedom with ARKS-NFT.
                </div>
              </div>
            </v-expand-transition>
          </v-card>
